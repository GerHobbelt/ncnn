...
{
	if(ymg.srcset){return ymg.srcset.split(' ')[0];}
	else{return ymg.src;}
}
...
function imhlarge()
{
	...
	var ostr=prompt('enlarge 1/x', '-2 z'+ymg.diz+' '+imhimgset(ymg));
	...
	if(isNaN(yx)){
		...
		var y=(yx<<0);
		ymg.src=imhbox.bs+y+imhbox.ext;
		ymg.diz=y+1;
		ymg.dizend=y+5;
		ymg.onerror=imherr;
		ymg.onclick=imhnxt;
...
if(fpgMode==1)
{
	...
	{
		setTimeout(function(){ele.src='http://127.0.0.1/m.gif';}, 3000);
	}
