...
function settxbox()
{
var txbx=document.getElementsByClassName('footer')[0];
txbx.innerHTML='';
var yina = document.createElement('textarea');
yina.cols=200;
yina.rows=200;
...
window.txbx=settxbox();

window.twilistl=twilist.length;
window.curna=0;
...
window.syko=setInterval(fioua, 80000);
